            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="w-100">
                            <form action="{!! route('admin.services.store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control summernote"
                                                      value="" name="short_descrition">
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">

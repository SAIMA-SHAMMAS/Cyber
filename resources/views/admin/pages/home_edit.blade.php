                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input  readonly type="text" required class="form-control" value="{!! $data['home']->name !!}"
                                                   name="name">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="section_1_heading_left">{!! $data['home']->section_1_heading_left !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2 mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="section_1_image">{!! $data['home']->section_1_image !!}</textarea>
                                        </div>
                                    </div>
                                </div><div class="row mb-2 mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="input-label">
                                            ...
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="section_1_image_background">{!! $data['home']->section_1_image_background !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2 mt-2">
                                    ...
                                    <div class="row mb-2 mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" required class="form-control summernote" value=""
                                                          name="section_1_heading_right">{!! $data['home']->section_1_heading_right !!}</textarea>
                                            </div>
                                        </div>
                                    </div> <div class="row mb-2 mt-2">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" required class="form-control summernote" value=""
                                                          name="section_1_description_right">{!! $data['home']->section_1_description_right !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2 mt-2">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" required class="form-control summernote" value=""
                                                      name="section_2_servise_logo">{!! $data['home']->section_2_servise_logo !!}</textarea>
                                        </div>
                                    </div>
                                </div>
{{--                                <div class="row mb-2 mt-2">--}}
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text"   class="form-control summernote"
                                                   name="section_3_brands_logo"> {!! $data['home']->section_3_brands_logo !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text"   class="form-control summernote"
                                                      name="section_4_title1"> {!! $data['home']->section_4_title1 !!}</textarea>
                                        </div>
                                    </div>
                                </div>
{{--                                <div class="row">--}}

            ...
            <a class="desktop-logo logo-light active" href="{!! route('admin.dashboard') !!}">
                <h2 style=" text-align: center">
                    <img src="{{ asset($setting->site_logo??'/dist/image/newlogo1.jpeg')   }}"
                         class=" " style="width: 17%" alt="logo"></h2>
            </a>
            ...
            <ul class="side-menu">
                ...
                <li class="sub-slide @if(Route::current()->getName()=="admin.services.create"  || Route::current()->getName()=="admin.services.index" ) is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide"
                       href="javascript:void(0);">
                                                    <span class="sub-side-menu__label">Services<i
                                                            class="sub-angle fe fe-chevron-down"></i> </span></a>
                ...
                <li class="sub-slide  @if(Route::current()->getName()=="admin.pages.create"  || Route::current()->getName()=="admin.pages.index" ) is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide"
                       href="javascript:void(0);"><span
                            class="sub-side-menu__label">Page</span><i
                ...
                <li class="sub-slide  @if(Route::current()->getName()=="admin.jobs.create"  || Route::current()->getName()=="admin.jobs.index" ) is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide"
                       href="javascript:void(0);"><span
                            class="sub-side-menu__label">Jobs</span><i
                            class="sub-angle fe fe-chevron-down"></i></a>
                    <ul class="sub-slide-menu">
                ...
                <li class="sub-slide @if(Route::current()->getName()=="admin.blogs.create"  || Route::current()->getName()=="admin.blogs.index" ) is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide"
                       href="javascript:void(0);">
                                                    <span class="sub-side-menu__label">Blogs<i
                                                            class="sub-angle fe fe-chevron-down"></i> </span></a>
                    <ul class="sub-slide-menu">
                ...
                <li class="sub-slide @if(Route::current()->getName()=="admin.gallery.create"  || Route::current()->getName()=="admin.gallery.index" ) is-expanded @endif">
                    <a class="slide-item" data-bs-toggle="sub-slide"
                       href="javascript:void(0);">
                                                    <span class="sub-side-menu__label">Gallery<i
                                                            class="sub-angle fe fe-chevron-down"></i> </span></a>
                    <ul class="sub-slide-menu">
                    ...
                    <ul class="sub-slide-menu">
                        ...
                        <li>
                            <a class="sub-side-menu__item  @if(Route::current()->getName()=="admin.filedownload"  ) active @endif"
                               href="{!! route('admin.filedownload') !!}">File Users </a></li>
                        <li>
                ...
                <li class="side-menu__label1"><a
                        href="javascript:void(0);">Setting</a>
                </li>
                ...
                <li class="side-item side-item-category">Site</li>
                    ...
                    <li class="slide @if(Route::current()->getName()=="admin.users.create"  || Route::current()->getName()=="admin.users.index" || Route::current()->getName()=="admin.permissions.create"  || Route::current()->getName()=="admin.permissions.index" || Route::current()->getName()=="admin.roles.create"  || Route::current()->getName()=="admin.roles.index") is-expanded @endif">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                            ...
                            <span class="side-menu__label">User Mangement</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane tab-content-show active" id="side26">
                                            <ul class="sidemenu-list">
                                                    ...
                                                    <li class="sub-slide  @if(Route::current()->getName()=="admin.users.create"  || Route::current()->getName()=="admin.users.index" ) is-expanded @endif">
                                                        <a class="slide-item" data-bs-toggle="sub-slide"
                                                           href="javascript:void(0);"><span
                                                ...
                                                @if (Gate::allows('Permissions'))
                                                    ...
                                                    <li class="sub-slide  @if(Route::current()->getName()=="admin.permissions.create"  || Route::current()->getName()=="admin.permissions.index" ) is-expanded @endif">
                                                        <a class="slide-item" data-bs-toggle="sub-slide"
                                                           href="javascript:void(0);"><span
                                                ...
                                                @if (Gate::allows('Roles'))
                                                    ...
                                                    <li class="sub-slide @if(Route::current()->getName()=="admin.roles.create"  || Route::current()->getName()=="admin.roles.index" ) is-expanded @endif">
                                                        <a class="slide-item" data-bs-toggle="sub-slide"
                                                           href="javascript:void(0);"><span
...
{{--                <li class="slide @if(Route::current()->getName()=="admin.country.create"  || Route::current()->getName()=="admin.country.index" || Route::current()->getName()=="admin.city.create"  || Route::current()->getName()=="admin.city.index" || Route::current()->getName()=="admin.pages.create"  || Route::current()->getName()=="admin.pages.index"   ||   Route::current()->getName()=="admin.subscriber.create"  || Route::current()->getName()=="admin.subscriber.index"  || Route::current()->getName()=="admin.services.create"  || Route::current()->getName()=="admin.services.index" || Route::current()->getName()=="admin.blogs.create"  || Route::current()->getName()=="admin.blogs.index" ||  Route::current()->getName()=="admin.brands.create"  || Route::current()->getName()=="admin.brands.index"  ||  Route::current()->getName()=="admin.gallery.create"  || Route::current()->getName()=="admin.gallery.index" ||  Route::current()->getName()=="admin.setting.page"  || Route::current()->getName()=="admin.media.create" ||  Route::current()->getName()=="admin.media.index"   )   is-expanded @endif">--}}
{{--                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">--}}
{{--                            <path d="M0 0h24v24H0V0z" fill="none"/>--}}
{{--                            <path--}}
